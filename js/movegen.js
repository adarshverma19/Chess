...
0000 0000 0000 0000 0000 0111 1111 -> AND 0x7F to Move bits to get the "from" square
0000 0000 0000 0011 1111 1000 0000 -> AND >> 7, 0x7F to Move bits to get the "to" square
0000 0000 0011 1100 0000 0000 0000 -> AND >> 14, 0xF to know the captured piece in the move
0000 0000 0100 0000 0000 0000 0000 -> AND 0x40000 to know whether the move is an en passant move, if the result of the and is 0 it is enpassant move
0000 0000 1000 0000 0000 0000 0000 -> AND 0x80000 to know whether the move is a pawn start 
0000 1111 0000 0000 0000 0000 0000 -> AND >> 20, 0xF to know the promoted piece type in the move
0001 0000 0000 0000 0000 0000 0000 -> AND 0x1000000 , to know whether the move is a catling move

*/

/*
Most Valuable Victim(MVV) and Least Valuable Attacker(LVA) 
 most valuable victims are Queen, Rook, Bishop, Knight, Pawn
 Least valuable attackers are Pawn, Knight, Bishop, Rook, Queen, King
 so pawn takes Queen is best move then knight takes queen and so on
